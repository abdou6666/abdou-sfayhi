        ...
        <header className='p-5'>
            ...
            <div className='mt-10'>
                ...
                <p>
                    ...
                    Here is some cool projects, I have worked on in my free time and made the cut.
                </p>
                <br />
                <p>
                    Currently I am doing an internship migrating a web application from WordPress to Next.js 13.4 and I will be adding cool features such as Real Time Communucation using WebSockets and WebRTC.
                </p>
            </div>
        </header>
    )
